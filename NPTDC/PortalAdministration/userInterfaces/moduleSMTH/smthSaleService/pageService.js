$('title').html(get_current_organization_title() + "SMTH Service List");

$('#menu_sale').addClass('active-sub');
$('#menu_sale_group').addClass('in');
$('#menu_sale_SaleService').addClass('active-link');
...
function Load_List() {
    ...
    $.ajax({
        ...
        url: baseUrl() + "WebServices/WebService_Service.asmx/GetAllServiceDate",
        data: "{ " +
