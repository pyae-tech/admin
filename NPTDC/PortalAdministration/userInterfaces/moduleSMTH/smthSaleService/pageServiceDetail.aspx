<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_Sale.master" AutoEventWireup="true" CodeBehind="pageServiceDetail.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSMTH.smthSaleService.pageServiceDetail" %>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            ...
            <div class="btn-group">
                ...
                <button data-dismiss="modal" class="btn btn-purple  btn-rounded  btn-labeled" type="button" onclick="GotoPage('Portal/SMTHServiceList');return false;"><i class="btn-label ion-close"></i><span class="bold" data-translate="_close">Close</span></button>
                            ...
                            <span><i class="ion-ios-refresh urllink" style="font-size: 21px;" onclick="Load_User_List();return false;"></i></span>&nbsp;  
                                                    ...
                                                    <div id="fuel_information" style="display: none;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="text" class="form-control filledFuel_calculator  calculate_fuelcharges" style="text-align: right;" onkeypress="return NumberExpressionWithoutSign(event.key)" id="tb_fAB_L" placeholder="Fuel(L) Before">
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="text" class="form-control filledFuel_calculator calculate_fuelcharges" style="text-align: right;" onkeypress="return NumberExpressionWithoutSign(event.key)" id="tb_after_amount" placeholder="Fuel(L) After">
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="text" class="form-control calculate_fuelcharges calculate_fuelcharges" style="text-align: right;" onkeypress="return NumberExpressionWithoutSign(event.key)" id="tb_fill_amount" placeholder="Filled Fuel(L)">
                                                            </div>
                                                            <label for="tb_bill_amount" class="col-md-2 control-label" data-translate=""><b>Price Per Liter</b></label>
                                                            <div class="col-md-2">
                                                                <input type="text" class="form-control calculate_fuelcharges" style="text-align: right;" onkeypress="return NumberExpressionWithoutSign(event.key)" id="tb_price_L" placeholder="Price Per Liter">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="text" class="form-control calculate_fuelcharges" style="text-align: right;" onkeypress="return NumberExpressionWithoutSign(event.key)" id="tb_charges_fuel" placeholder="Charges of Fuel" readonly="true">
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control calculate_fuelcharges" style="text-align: right;" onkeypress="return NumberExpressionWithoutSign(event.key)" id="tb_ser_charges" placeholder="Service Charges">
                                                        </div>
                                                        <div class="col-md-4">
                                ...
                                <textarea rows="2" class="form-control" id="tb_description" placeholder="Enter Remark"></textarea>
                                                   ...
                                                   <%-- <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button class="btn btn-dark  btn-rounded  btn-labeled" type="button" onclick="GotoPage('Portal/SMTHServiceDetail');return false;"><i class="btn-label ion-plus-round"></i><span class="bold" data-translate="_new">New</span></button>
                                                        <button class="btn btn-mint  btn-rounded  btn-labeled" type="button" onclick="GoToLog();return false;"><i class="btn-label ion-clock"></i><span data-translate="_log" class="bold">Log</span></button>
                                                        <button data-dismiss="modal" class="btn btn-dark  btn-rounded  btn-labeled" type="button" onclick="GotoPage('Portal/SMTHServiceList');return false;"><i class="btn-label ion-close"></i><span class="bold" data-translate="_close">Close</span></button>
