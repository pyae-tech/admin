<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_Sale.Master" AutoEventWireup="true" CodeBehind="pageSaleOrder.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSaleVan.saleOrder.pageSaleOrder" %>
        ...
        <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <label for="tb_location" class="col-md-2 control-label" data-translate="_ordstatus">Status</label>
                                <div class="col-md-3">
                           ...
                           <br />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select id="tb_customer_name" class="form-control demo_select2"></select>
                                </div>
                            </div>
                           <br />
                            <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="panel ">
                    <div class="panel-heading">
                        <div class="panel-control">
                            <button class="btn btn-primary  btn-rounded btn-sm  btn-labeled" type="button" onclick="add_new_order_item();return false;"><i class="btn-label ion-plus-round"></i><span class="bold" data-translate="_new">New Item</span></button>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_JS" runat="server">
    ...
    <script src='<%= ResolveUrl("pageSaleOrder.js")%>'></script>
</asp:Content>
