...
{
    public partial class pageWeeklySaleOrderOfCustomer : System.Web.UI.Page
    {
        ...
        protected void BtnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            if (orderid != "" && customerid != "" && requestid != "")
            {
                ...
                List<SBSPortal3.Controllers.Controller_Order.AdvancedOrderItemView> orderItems = Controllers.Controller_Order.GetAllAdvancedOrderItems(orderid, customerid, requestid);
