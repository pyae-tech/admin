<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_VanSale.master" AutoEventWireup="true" CodeBehind="pageWeeklySaleOrderOfCustomerList.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSaleVan.weeklySaleOrderOfCustomer.pageWeeklySaleOrderOfCustomerList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Header" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <button class="btn btn-dark  btn-rounded  btn-labeled" type="button" onclick="GotoPage('Portal/weeklySaleOrder');return false;"><i class="btn-label ion-plus-round"></i><span class="bold" data-translate="_new">New</span></button>
    </ol>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End breadcrumb-->
                ...
                <div class="panel">
                    <div class="tabs-container" id="tab-main">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3><i class="ion-printer" data-translate=""></i>&nbsp;<span>Weekly Sale Orders</span></h3>
                        </div>
                        <!--Panel body-->
                        <div class="panel-body">
                                ...
                                <div class="tab-pane fade in " id="tab-list">
                                    ...
                                    <table style="display: none">
                                        <tbody id="template_row">
                                            <tr style="cursor: pointer;" onclick="GotoPage('Portal/weeklySaleOrder?id=[OrderID]&cusid=[CustomerID]');return false;">
                                                <td>[OrderNo]</td>
                                                <td>[OrderDate]</td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_JS" runat="server">
      <script src='<%= ResolveUrl("pageWeeklySaleOrderOfCustomerList.js")%>'></script>
</asp:Content>
