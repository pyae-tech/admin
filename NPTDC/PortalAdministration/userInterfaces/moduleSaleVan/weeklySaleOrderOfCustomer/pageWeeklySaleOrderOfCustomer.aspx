<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_VanSale.master" AutoEventWireup="true" CodeBehind="pageWeeklySaleOrderOfCustomer.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSaleVan.monthlySaleOrder.pageWeeklySaleOrderOfCustomer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Header" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            ...
            <button class="btn btn-mint  btn-rounded  btn-labeled" data-translate="_new" type="button" onclick="GotoPage('portal/weeklySaleOrder?id=');return false;"><i class="btn-label ion-plus-round"></i><span class="bold">New</span></button>
            ...
            <button class="btn btn-dark  btn-rounded  btn-labeled" data-translate="_close" type="button" onclick="GotoPage('portal/weeklySaleOrders');return false;"><i class="btn-label ion-close"></i><span class="bold">Close</span></button>
                                ...
                                <div class="panel  ">
                                  ...
                                  <form runat="server">
                                   ...
                                   <input type="hidden" id="checkStatus"/>
                                     <asp:Button ID="BtnExportToExcel" runat="server" Text="Export To Excel" CssClass="btn btn-mint btn-rounded" style="float:right;margin-top: 27px;" OnClick="BtnExportToExcel_Click"/>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input type="hidden" id="hf_customerid" value="" />
                                                <input type="text" class="form-control" id="tb_customer" placeholder="Customer" readonly="true" tabindex="-1">
                                            </div>
                                                 </div>
                                                ...
                                                <table style="display: none">
                                                    <tbody id="div_item_template">
                                                        <tr style="cursor: pointer;">
                                                            ...
                                                            <td>[ItemNo]</td>
                                                            <td><b>[ItemName]</b>
                                                                <br /><small>[OrderQtySequence]</small>
                                                                 <br /><small>[moq]</small>
                                                            </td>
                                                            ...
                                                            <td class="ThuHeader" onclick="rowEdit('[ItemNo49]','#sp_thuQty_','#tb_edit_thuQty_','[ItemID7]');">
                                                                ...
                                                                <%--<input type="hidden" id="tb_customerGroupID" value="" />--%>
                                                                <input type="number" min="0" moq_value="[moq]"  sequence_value="[OrderQtySequence]" orginal_value="[Thu_OrderQty],[ItemID8],[ItemNo50]" class="form-control checksequence editOrderQty_[ItemNo11]" id="tb_edit_thuQty_[ItemNo12]" style="display: block; text-align: right;" value="[Thu_OrderQty]" <%--onchange="rowAcep('[ItemID8]','[ItemNo50]');"--%>>
                                                            </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_JS" runat="server">
      <script src='<%= ResolveUrl("pageWeeklySaleOrderOfCustomer.js")%>'></script>
</asp:Content>
