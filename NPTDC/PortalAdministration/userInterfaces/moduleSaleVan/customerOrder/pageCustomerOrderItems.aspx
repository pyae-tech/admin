<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_VanSale.master" AutoEventWireup="true" CodeBehind="pageCustomerOrderItems.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSaleVan.customerOrder.pageCustomerOrderItems" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Header" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <button class="btn btn-dark  btn-rounded  btn-labeled" type="button" onclick="GotoPage('Portal/customerorderitem');return false;"><i class="btn-label ion-plus-round"></i><span class="bold" data-translate="_new">New</span></button>
    </ol>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End breadcrumb-->
                ...
                <div class="panel">
                    <div class="tabs-container" id="tab-main">
                        ...
                        <div class="panel-heading">
                            ...
                            <h3><i class="ion-printer" data-translate="_orderdetail"></i>  Orders<span class="list_total_amount"></span></h3>
                        </div>
                        <!--Panel body-->
                        <div class="panel-body">
                                ...
                                <div class="tab-pane fade in " id="tab-list">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4">
					                            ...
					                            <button class="btn  btn-primary  btn-rounded  btn-labeled" type="button" onclick="change_date('previous'); return false;">
                                                    ...
                                                    <span class="bold">ေရွ႕</span></button>
                                                <button class="btn  btn-primary  btn-rounded  btn-labeled" type="button" onclick="change_date('next'); return false;"> 
                                                    <span class="bold">ေနာက္</span>    <i class="btn-label ion-chevron-right"></i></button>
					                        </div>
                                    ...
                                    <table style="display: none">
                                        <tbody id="template_row">
                                            <tr style="cursor: pointer;" onclick="GotoPage('Portal/order?id=[OrderID]');return false;">
                                                <td>[OrderNo]</td>
                                                <td>[OrderDate]</td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_JS" runat="server">
      <script src='<%= ResolveUrl("pageCustomerOrderItems.js")%>'></script>
</asp:Content>
