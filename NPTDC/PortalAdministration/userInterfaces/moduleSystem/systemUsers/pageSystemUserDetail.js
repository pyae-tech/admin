...
function SaveUser() {
    ...
    $.ajax({
        ...
        data: "{ " +
            ...
            ",'contactinfo':'" + $("#tb_contact_info").text() + "' " +
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.d != null) {
                    ...
                    Load_User_Role_List();
                    var role_id1 = data.d["RoleID"];
                    if (role_id1 == null || role_id == "undefined") {
                        role_id1 = "";
                        $("#lookup_role").dxLookup('instance').option('value',role_id1);
                    }
                    else {
                    ...
                    var dep_id1 = data.d["DepartmentID"];
                    if (dep_id1 == null || dep_id1 == "undefined") {
                        dep_id1 = "";
                        $("#lookup_department").dxLookup('instance').option('value',dep_id1);
                    }
                    else {
                        $("#lookup_department").dxLookup('instance').option('value',dep_id1);
                    ...
                    var pos_id1 = data.d["PositionID"];
                    if (pos_id1 == null || pos_id1 == "undefined") {
                        pos_id1 = "";
                        $("#lookup_position").dxLookup('instance').option('value',pos_id1);
                    }
                    else {
                        $("#lookup_position").dxLookup('instance').option('value',pos_id1);
