<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_MasterBook.Master" AutoEventWireup="true" CodeBehind="pageExchangeRate.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleMaster.masterExchangeRate.pageExchangeRate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Header" runat="server">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Exchange Rate</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
            ...
            <div class="panel-body">
                ...
                <div class="panel">
                    <div class="tabs-container" id="tab-main">
                        ...
                        <h3><i class="ion-social-usd"></i> Exchange Rate</h3>
                        <!--Panel body-->
                        <div class="panel-body">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Exchange Rate - Detail Infromation</h4>
                </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="tb_address" class="col-md-3 control-label">From Currency</label>
                            <div class="col-md-3">
                                  <input type="hidden" id="hf_fromCurrencyID" value="" />
                                <select id="ddl_from_currency" class="form-control demo_select2">
                         ...
                         <div class="form-group">
                            <label for="tb_address" class="col-md-3 control-label">To Currency</label>
                            <div class="col-md-3">
                                 <input type="hidden" id="hf_toCurrencyID" value="" />
                                <select id="ddl_to_currency" class="form-control demo_select2">
                        ...
                        <div class="form-group">
                                <label for="tb_description" class="col-md-3 control-label">Exchange Rate</label>
                                   <div class="col-md-3">
                                   <input type="text" class="form-control" style="text-align: right;" id="tb_exc_rate" placeholder="Enter Exchange Rate">
                                    </div>
                                     </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary  btn-rounded  btn-labeled" type="button" onclick="SaveExchangeRate();return false;"><i class="btn-label ion-checkmark"></i><span class="bold">Save</span></button>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_JS" runat="server">
    ...
    <script src='<%= ResolveUrl("../../../plugins/backDetect/jquery.backDetect.js")%>'></script>
     <script src='<%= ResolveUrl("pageExchangeRate.js")%>'></script>
</asp:Content>
