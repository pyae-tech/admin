<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_CustomerGroupLogin.Master" AutoEventWireup="true" CodeBehind="pageCustomerGroupService.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSale.service.pageCustomerGroupService" %>
                                ...
                                <div class="tab-pane fade in " id="tab-list">
                                    ...
                                    <table style="display: none">
                                        <tbody id="template_row">
                                            <tr style="cursor: pointer;" onclick="GotoPage('Portal/customergroupservice?id=[ServiceID]');return false;">
