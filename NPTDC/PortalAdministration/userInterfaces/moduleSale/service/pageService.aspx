<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_Sale.Master" AutoEventWireup="true" CodeBehind="pageService.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSale.service.pageService" %>
                        ...
                        <div class="panel-body" id="backdetect">
                            ...
                            <%--        <table style="display: none">
                                        <tbody id="template_row">
                                            <tr style="cursor: pointer;" onclick="GotoPage('Portal/service?id=[ServiceID]');return false;">
