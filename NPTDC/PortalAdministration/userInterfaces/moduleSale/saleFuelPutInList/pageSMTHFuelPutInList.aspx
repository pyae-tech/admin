<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_Sale.master" AutoEventWireup="true" CodeBehind="pageSMTHFuelPutInList.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSale.saleFuelPutInList.pageSMTHFuelPutInList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Header" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active" data-translate="">Fuel Put In List</li>
        <li class="active">
            <button class="btn btn-dark  btn-rounded  btn-labeled" type="button" onclick="ShowReport();return false;"><i class="btn-label ion-plus-round"></i><span class="bold" data-translate="">Show on Print View</span></button>
    </ol>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_JS" runat="server">
    ...
    <script src='<%=ResolveUrl("pageSMTHFuelPutInList.js")%>'></script>
