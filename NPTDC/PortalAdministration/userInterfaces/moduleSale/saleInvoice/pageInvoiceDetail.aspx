<%@ Page Title="" Language="C#" MasterPageFile="~/PortalAdministration/userInterfaces/moduleSystem/masterFiles/FullFrameMaster_Sale.Master" AutoEventWireup="true" CodeBehind="pageInvoiceDetail.aspx.cs" Inherits="SBSPortal3.PortalAdministration.userInterfaces.moduleSale.saleInvoice.pageInvoiceDetail" %>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            ...
            <div class="btn-group">
                ...
                <button class="btn btn-purple  btn-rounded  btn-labeled" type="button" onclick="GotoPage('portal/invoice?id=');return false;"><i class="btn-label ion-plus-round"></i><span class="bold" data-translate="_new">New</span></button>
                ...
                <button class="btn btn-purple  btn-rounded  btn-labeled" type="button" onclick="GotoPage('portal/invoices');return false;"><i class="btn-label ion-close"></i><span class="bold" data-translate="_close">Close</span></button>
