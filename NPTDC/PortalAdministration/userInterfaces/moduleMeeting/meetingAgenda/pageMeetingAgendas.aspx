...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_TopLeftMenu" runat="server">
  <ol class="menucrumb">
        <li>
 <button style="display: none;" class="btn  btn-dark   btn-rounded  btn-labeled agenda_create" type="button" onclick="NewAgenda();return false;"><i class="btn-label ion-plus-round"></i>
             <span class="bold" data-translate="_new">စာရင်း အသစ်သွင်းရန်</span></button></li>
     <li>      <button class="btn  btn-dark   btn-rounded  btn-labeled" type="button" onclick="Refresh();return false;"><i class="btn-label ion-refresh"></i><span class="bold" data-translate="_reflesh">ပြန်ဖွင့်</span></button>
</li></ol>
</asp:Content>
